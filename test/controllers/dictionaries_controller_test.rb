...
class DictionariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dictionary" do
    assert_difference('Dictionary.count') do
      post dictionaries_url, params: { dictionary: { description: @dictionary.description, example: @dictionary.example, grammer: @dictionary.grammer, translate: @dictionary.translate, word: @dictionary.word } }
    end
  ...
  test "should update dictionary" do
    patch dictionary_url(@dictionary), params: { dictionary: { description: @dictionary.description, example: @dictionary.example, grammer: @dictionary.grammer, translate: @dictionary.translate, word: @dictionary.word } }
